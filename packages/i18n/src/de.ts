...
export const de = {
  ...
  'setup.3.title': 'Einmal starten',
  'setup.3.body': 'Beim ersten Start wird das Modell heruntergeladen, das dauert ein paar Minuten. Die Kosten laufen dabei sichtbar mit.',
