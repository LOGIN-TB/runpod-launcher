...
export const en = {
  ...
  'pods.title': 'Pods',
  'pods.none': 'No pods',
  'pods.noneHint': 'Nothing is rented, so nothing is being billed.',
  'pods.active': 'In use',
  'pods.use': 'Use this one',
  'pods.start': 'Start',
  ...
  'setup.3.body': 'The first start downloads the model — five to fifteen minutes for a 20 GB one. The pod shows Getting ready until the engine answers, then Ready. Send a test request to confirm it really works.',
